...
function pegueiAhorario(time) {
    if (time < 12) { saudação.innerHTML = 'Bom Dia!' }
    else if (time < 18) { saudação.innerHTML = 'Boa tarde!' }
    else if (time < 24) { saudação.innerHTML = 'Boa Noite!' }
}   